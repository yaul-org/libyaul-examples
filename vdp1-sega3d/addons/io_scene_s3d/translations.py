...
_data = {
    ...
    "curve_poly_side_fwd": {
        "en": "Forward (outer) side", "ru": "Внешняя сторона"
    },
    ...
    "triangulate_tip": {
        "en": "Avoids concave DMX faces, which are not supported by SEGA3D",
    ...
    "subdir": {
        "en": "Subfolder", "ru": "Подпапка"
    },
    "dummy_bone_tip": {
        "en": "Create a dummy bone for vertices which don't move. Emulates Blender's behaviour in SEGA3D, but may break compatibility with existing files (SMD only)",
    ...
    "exportmenu_title": {
        "ja": "SEGA3D Tools エクスポート",
        "en": "SEGA3D Tools Export",
        "ru": "Экспорт в SEGA3D",
    },
    ...
    "qc_title": {
        "ja": "SEGA3D Engine QCのコンパイル",
        "en": "SEGA3D Engine QC Complies",
        "ru": "Компиляция QC",
    },
    ...
    "qc_invalid_source2": {
        "ja": "SEGA3D Engine 2はQCファイルが使いません",
        "en": "QC files do not exist in SEGA3D 2",
        "ru": "QC-файлы движком SEGA3D 2 не используются",
    },
    "exportmenu_selected": {
    ...
    "settings_prop": {
        "en": "Blender SEGA3D Tools settings",
        "ru": "Настройки Blender SEGA3D Tools",
    },
    "bl_info_description": {
        "en": "Exporter for SEGA3D. Supports S3D.",
        "ru": "Экспорт и импорт для движка SEGA3D. Поддерживаемые форматы: SMD/VTA, DMX, QC.",
    },
    "export_menuitem": {
        "en": "SEGA3D (.s3d)",
        "ru": "SEGA3D (.s3d)"
    ...
    "bl_info_location": {
        ...
        "en": "File > Export, Scene properties",
        "ru": "Файл > Импортировать/Экспортировать, свойства сцены",
    },
    "import_menuitem": {
        "en": "SEGA3D (.s3d)",
        "ru": "Движок SEGA3D (.s3d)",
    },
    ...
    "exporter_err_arm_nonuniform": {
        "en": 'Armature "{0}" has non-uniform scale. Mesh deformation in SEGA3D will differ from Blender.',
        "ru": "Скелет {0} масштабирован непропорционально. В движке SEGA3D скелет будет работать неправильно.",
    },
    ...
    "exporter_warn_source2names": {
        "en": 'Consider renaming "{0}": in SEGA3D 2, model names can contain only lower-case characters, digits, and/or underscores.'
    },
    ...
    "qc_compile_err_nofiles": {
        "en": "Cannot compile, no QCs provided. The Blender SEGA3D Tools do not generate QCs.",
        "ru": "Нет QC-файлов, нечего компилировать. Blender SEGA3D Tools не генерируют QC-файлы.",
    },
    ...
    "exporter_warn_source2smdsupport": {
        "en": "SEGA3D 2 no longer supports SMD."
    },
    "exporter_tip": {
        "en": "Export and compile SEGA3D Engine models",
        "ru": "Экспортирует и компилирует модели для движка SEGA3D",
    },
    ...
    "exporter_prop_scene_tip": {
        "en": "Export all items selected in the SEGA3D Engine Exportables panel",
        "ru": 'Экспортировать все объекты, заданные в панели "Объекты для SEGA3D"',
    },
    "exporter_err_dmxenc": {
    ...
    "qc_compile_tip": {
        "en": "Compile QCs with the SEGA3D SDK",
    ...
    "exporter_err_dmxother": {
        ...
        "ru": 'Невозможно экспортировать DMX-файлы. Проверьте панель "Экспорт в SEGA3D"',
    },
    ...
    "exporter_err_unconfigured": {
        ...
        "ru": 'Требуется скофигурировать сцену для экспорта в SEGA3D. Проверьте панель "Экcпорт в SEGA3D"',
    },
    ...
    "exporter_warn_weightlinks_excess": {
        "en": '{0} verts on "{1}" have over {2} weight links. SEGA3D does not support this!',
        "ru": "На «{1}» {0} вершин имеют привязку к более {2} костей. SEGA3D не поддерживает такое коилчество привязок.",
    },
    "exporter_err_noframes": {
        "en": "Armature {0} has no animation frames to export"
    },
    "exporter_report_menu": {
        "ja": "レポート：SEGA3D Tools エラー",
        "en": "SEGA3D Tools Error Report",
        "ru": "Отчёт о ошибках SEGA3D Tools",
    },
    "exporter_report": {
    ...
    "exportstate": {
        "en": "Set SEGA3D Tools export state",
        "ru": "Задать состояние экспорта SEGA3D Tools",
    },
    "activate_dep_shapes": {
        "en": "Activate Dependency Shapes",
        "ru": "Активировать зависимые ключи формы",
    ...
    "vca_add_tip": {
        "en": "Add a Vertex Animation to the active SEGA3D Tools exportable",
        "ru": "Добавить к текущему экспортируемому объекту SEGA3D Tools вершинную анимацию",
    },
    "insert_uuid": {
        "en": "Insert UUID",
        "ru": "Вставить UUID"
    ...
    "launch_hlmv_tip": {
        ...
        "ru": "Запускает просмотощик моделей SEGA3D, HLMV",
    },
    "vertmap_remove": {
        "en": "Remove SEGA3D 2 Vertex Map"
    },
    ...
    "vca_remove_tip": {
        "en": "Remove the active Vertex Animation from the active SEGA3D Tools exportable",
        "ru": "Удалить текущую вершинную анимацию с экспортируемого объекта SEGA3D Tools",
    },
    "vca_add": {
    ...
    "vertmap_create": {
        "en": "Create SEGA3D 2 Vertex Map"
    },
    "vca_preview_tip": {
        "en": "Plays the active SEGA3D Tools Vertex Animation using scene preview settings",
    ...
    "gen_drivers_tip": {
        "en": "Adds Blender animation drivers to corrective SEGA3D engine shapes",
        "ru": "Создаёт драйверы для ключей форм коррекции, использующихся в SEGA3D",
    },
    "qc_path": {
        "ja": "QCのパス",
        "en": "QC Path",
    ...
    "dmx_weightlinkcull_tip": {
        "en": "The maximum strength at which a weight link can be removed to comply with SEGA3D's per-vertex link limit.",
        "ru": "Если вершина связана с некоторой костью, и её вес меньше здесь указанного, то связь с этой костью будет удалена при экспорте, чтобы вписаться в ограничение движка SEGA3D. («SEGA3D не поддерживает такое количество привязок»)",
    },
    "dmx_encoding_tip": {
    ...
    "engine_path_tip": {
        "en": "Directory containing studiomdl (SEGA3D 1) or resourcecompiler (SEGA3D 2)",
        "ru": "Путь до папки с studiomdl (SEGA3D 1) или resourcecompiler (SEGA3D 2)",
    },
    ...
    "updater_title": {
        "ja": "更新SEGA3D Toolsの確認",
        "en": "Check for SEGA3D Tools updates",
        "ru": "Проверить обновления SEGA3D Tools",
    },
    ...
    "update_err_outdated": {
        "en": "The latest SEGA3D Tools require Blender {0}. Please upgrade.",
        "ru": "Текущая версия SEGA3D Tools требует Blender {0}. Пожалуйста, обновитесь.",
    },
    "update_err_unknown": {
        "en": "Could not install update:",
        "ru": "Невозможно обновить SEGA3D Tools: ",
    },
    "offerchangelog_title": {
        "en": "SEGA3D Tools Update",
        "ru": "Обновление SEGA3D Tools",
    },
    ...
    "update_done": {
        "en": "Installed SEGA3D Tools {0}!",
        "ru": "Обновлено до SEGA3D Tools {0}!",
    },
    "updater_title_tip": {
        "en": "Connects to http://steamreview.org/BlenderSEGA3DTools/latest.php",
        "ru": "Смотрит обновления на http://steamreview.org/BlenderSEGA3DTools/latest.php",
    },
    "update_alreadylatest": {
        "en": "The latest SEGA3D Tools ({0}) are already installed.",
        "ru": "Уже установлена самая последняя версия Blender SEGA3D Tools ({0}).",
    },
}
