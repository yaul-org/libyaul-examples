...
/* Setting the unused timing cycles from 0xF to 0xE increased performance
...
static uint32_t _tga_file_decode(const char *, void *, void *) __unused;
...
main(void)
{
        ...
        intermediate_buffer = malloc(16384);
        ...
        while (true) {
                ...
                (void)memcpy(vram, &intermediate_buffer[0], intermediate_size);
